...
def update_dashboard(selected_products, selected_priorities, selected_statuses):
    dff = df.copy()
    ...
    colors = [priority_colors.get(p, COLORS['secondary']) for p in priority_counts.index]
